    ...
    >
      <View style={{ justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center', width: '100%' }}>
        <View style={{ backgroundColor: '#fff', borderRadius: 50, padding: 10, elevation: 2 }}>
          <MaterialCommunityIcons name='cat' color={'#006766'} size={30} />
        </View>
        ...
        >
          <Text style={{ fontWeight: 'bold', color: '#31352E' }}>
            {item.breed} | <Text style={{ color: '#00000070' }}>{item.animal_type}</Text>
          </Text>
        </View>
  ...
  return (
    <>
      ...
      <View style={styles.container}>
        <View>
          <FAB style={styles.fab} medium icon='plus' color='#fff' onPress={() => navigation.navigate('AddBreed')} />
        </View>
        <View>
