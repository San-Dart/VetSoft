  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
        ...
        <Image style={styles.tinyLogo} source={require('../../assets/logov.png')} />
      </View>
      <View style={styles.footer}>
        ...
        <View style={styles.action}>
          <MaterialIcons name='email' size={30} color='#00000090' />
          <TextInput
        ...
        <View style={styles.action}>
          <MaterialIcons name='lock' size={30} color='#00000090' />
          <TextInput
