...
const BranchFilter = (props) => {
  ...
  return (
    <View>
      <TouchableOpacity style={styles.filterBox} onPress={() => setDropdownOpen(true)}>
        <MaterialIcons
          name='settings'
          color={'#000'}
          size={30}
          style={{ backgroundColor: '#d4d2d2', padding: 5, height: 40, borderRadius: 10, borderColor: '#d4d2d2' }}
        />
      </TouchableOpacity>
