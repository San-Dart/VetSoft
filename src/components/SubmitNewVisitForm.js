...
const SubmitNewVisitForm = ({ navigation, route }) => {
  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <Text style={{ textAlign: 'center', opacity: 0.4, marginTop: 10 }}>
        App Message are sent by default. Only thing Send Message should be toggled on
      </Text>
