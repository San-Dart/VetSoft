...
// axios.defaults.baseURL = "http://192.168.1.170:8000/api";
        ...
        <NavigationContainer>
          {loginState.userToken !== null ? (
            ...
            >
              ...
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails, header: 'Pets' }}
                name='Pets'
                component={Pets}
                options={{ headerShown: false }}
              />
              ...
              <Stack.Screen
                ...
                name='Animal'
                component={Animal}
                options={{ title: 'Masters/Animal' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='Breed'
                component={Breed}
                options={{ title: 'Masters/Breed' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='Colors'
                component={Colors}
                options={{ title: 'Masters/Colors' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='Disease'
                component={Disease}
                options={{ title: 'Masters/Disease' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='Medicine'
                component={Medicine}
                options={{ title: 'Masters/Medicine' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='Symptoms'
                component={Symptoms}
                options={{ title: 'Masters/Symptoms' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='Vaccines'
                component={Vaccines}
                options={{ title: 'Masters/Vaccines' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='VisitType'
              ...
              <Stack.Screen
                ...
                name='AddAnimal'
                component={AddAnimal}
                options={{ title: 'Create a New Animal', headerShown: false }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='AddBreed'
                component={AddBreed}
                options={{ title: 'Create a New Breed', headerShown: false }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='AddDisease'
              ...
              <Stack.Screen
                ...
                name='AddColor'
                component={AddColor}
                options={{ title: 'Add Color', headerShown: false }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='AddVisitType'
                component={AddVisitType}
                options={{ title: 'Add Visit Type' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
              ...
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='SubscriptionAndBilling'
                component={SubscriptionAndBilling}
                options={{ title: 'Subscription And Billing' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='LeftCredits'
                component={LeftCredits}
                options={{ title: 'Left Credits' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
              ...
              <Stack.Screen
                ...
                name='AddPet'
                component={AddPet}
                options={{ headerShown: false, title: 'Create a new pet' }}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='Message'
              ...
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='SubmitNewVisitForm'
                component={SubmitNewVisitForm}
              />
              <Stack.Screen
                initialParams={{ userDetails: loginState.userDetails }}
                name='petSubmitPage'
